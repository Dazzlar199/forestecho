      ...
      <div className="max-w-4xl mx-auto">
        ...
        {!showForm && (
          <button
            ...
            className={`mb-6 px-6 py-3 rounded-xl font-medium transition-all ${
              theme === 'dark'
                ? 'bg-emerald-600 hover:bg-emerald-700 text-white'
                : 'bg-emerald-500 hover:bg-emerald-600 text-white'
            }`}
          >
            <Send className="w-5 h-5 inline mr-2" />새 문의 작성
          </button>
        )}
        ...
        <div className="space-y-4">
          ...
          {inquiries.length === 0 ? (
            ...
            >
              ...
              <p className={theme === 'dark' ? 'text-gray-400' : 'text-gray-600'}>아직 문의 내역이 없습니다</p>
            </div>
          ) : (
              ...
              return (
                ...
                >
                  ...
                  {inquiry.adminReply && (
                    ...
                    >
                      <div className={`text-sm font-medium mb-2 ${theme === 'dark' ? 'text-emerald-400' : 'text-emerald-600'}`}>
                        관리자 답변
                      </div>
